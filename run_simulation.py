...
def main():
    ...
    parser.add_argument("--enable_output", type=bool, default=False, help="save simulation to disk")
    parser.add_argument("--output", type=str, default="output/particles", help="output path for simulation result")
    parser.add_argument("--realtime_preview", type=bool, default=True, help="open a preview window")
